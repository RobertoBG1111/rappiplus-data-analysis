...
<img src="./images/distribucion_precio_laptop.png" alt="Laptop-Gaming-16GB selling price distribution vs. unit cost" width="500"/>
<img src="./images/funnel.png" alt="Conversion funnel from first_visit to purchase" width="500"/>

Full methodology and findings in [`conclusion.md`](./conclusion.md) *(Spanish)*.
