...
Detalle completo de metodología y hallazgos en [`conclusiones_proyecto_final_rappiplus.md`](./conclusiones_proyecto_final_rappiplus.md).
...
| id_usuario | Categória | Identificador del usuarios que realizó el pedido |
...
| monto_total | numérico | Monto toal pagado por el pedido |
